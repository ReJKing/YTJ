...
- (void)viewDidLoad {
    ...
    MoiveDetailHeadView *mdView = [MoiveDetailHeadView moiveDetailHeadView];
    mdView.obj = _moiveObj;
    [self.headView addSubview:mdView];
...
- (void)setMoiveObj:(MoivesObj *)moiveObj{
    _moiveObj = moiveObj;
    self.title = moiveObj.name;
